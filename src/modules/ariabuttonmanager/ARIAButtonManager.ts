...
import MMB from "../managedinitiation/ManagedModuleBase";
class ARIAButtonManager extends MMB.Base
{
    "use strict";
    ...
    protected addEventsToElements(element: HTMLElement)
	{
		...
		{
			requirejs(["./ARIAButtonManagerAdditionalBehavior"], (_ARIAButtonManagerAdditionalBehavior: ARIAButtonManagerAdditionalBehaviorsModule) =>
			{
				_ARIAButtonManagerAdditionalBehavior.addBehaviors($element, $target);
			});
		}
